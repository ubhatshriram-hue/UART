...
module refrence #(parameter clk_value= 100000000,parameter baud=9600,parameter data_width=8)(input wire sys_clk,sys_rst_l,xmitH,input wire [data_width-1:0]xmit_dataH,input wire uart_REC_dataH,output reg uart_XMIT_dataH,xmit_doneH,xmit_active,rec_readyH,rec_busyH,output reg [data_width-1:0]rec_dataH,output wire uart_clk_out);
